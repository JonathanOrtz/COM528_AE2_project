...
//        }
    ...
    public String catalogList(@RequestParam(name = "action", required = false) String action,
            @RequestParam(name = "itemName", required = false) String itemName,
...
//        availableItems.add(item);
        ...
        if ("removeItemFromCatalog".equals(action)) {
            shoppingService.removeItemFromCatalog(itemId);
        } 
